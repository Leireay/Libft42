...
ft_striteri.c ft_isprint.c ft_isascii.c ft_isalnum.c ft_memchr.c ft_memcpy.c\
ft_memmove.c ft_memcmp.c ft_strchr.c ft_strdup.c ft_strlcat.c ft_strlcpy.c\
